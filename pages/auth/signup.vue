...
<template>
  <main
    ...
    style="background-image: url('/images/signup_background_image.jpeg')"
  >
    <div
      tabindex="-1"
          ...
          <div class="p-5">
            ...
            <form class="w-full" @submit.prevent>
              ...
              <input
                ...
                v-model="store.createuser_data.email"
              />
              <div class="relative">
                ...
                <input
                  ...
                  value=""
                  v-model="store.createuser_data.password"
                />
                <button
            ...
            <div class="mt-6 text-center text-sm text-slate-600">
              ...
              <NuxtLink to="/auth/signin" class="font-medium text-[#4285f4]"
                >Sign in</NuxtLink
              >
              <div class="mt-5">
                I agree Terms and Condition by clicking sign up button
              </div>
            </div>
          </div>
        </div>
